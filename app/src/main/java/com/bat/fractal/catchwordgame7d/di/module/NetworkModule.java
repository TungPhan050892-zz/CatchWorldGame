package com.bat.fractal.catchwordgame7d.di.module;
...
public class NetworkModule {
    ...
    private static final String HTTP_CACHE = "acarepharmacy_http_cache";
...
//            Log.e(TAG, context.getString(R.string.cant_create_cache));
        }
        return cache;
    }
    ...
    @Provides
    @Singleton
    public CatchWordGameDataRepository provideTripleFiveAppRepository(){
        return new CatchWordGameDataRepository(providesNetworkService());
    }
}
